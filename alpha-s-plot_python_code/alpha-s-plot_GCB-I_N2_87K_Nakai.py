...
plt.title("alpha-s-plot (GCB-I std., N2 87K, Nakai), ads", fontsize=18, fontname='DejaVu Serif')
fig.savefig('./plot/alpha-s-plot_GCB-I_N2_87K_Nakai.jpg')
...
dft.T.to_csv("./plot/alpha-s-plot_GCB-I_N2_87K_Nakai.csv")