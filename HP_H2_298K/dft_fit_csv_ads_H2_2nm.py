...
# plot
fig1 = plt.figure(1)
#fig1.savefig('./plot/H2_77K_2nm_ADS_Fit.jpg')
fig1.savefig('./plot/H2_298K_2nm_ADS_Fit.jpg')
fig2 = plt.figure(2)
#fig2.savefig('./plot/H2_77K_2nm_ADS_PSD.jpg')
fig2.savefig('./plot/H2_298K_2nm_ADS_PSD.jpg')
#plt.show()
...
#fig.savefig('./plot/H2_77K_2nm_deltaS_ADS.jpg')
fig.savefig('./plot/H2_298K_2nm_deltaS_ADS.jpg')
#plt.show()
...
#import pprint
#pprint.pprint(ndf)
#ndf.to_csv("./plot/H2_77K_2nm_ADS.csv", index=False)
ndf.to_csv("./plot/H2_298K_2nm_ADS.csv", index=False)
